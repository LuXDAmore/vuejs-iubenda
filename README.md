...
Navigate to the `/challenge` page and play with the form-fields, then save the data when you want to.
The data is saved into the store, and the form can be saved again only after updating fields again.

If the user clicks one of the CookieBanner's buttons, the results are also saved into the store and can be viewed in the "PiniaStore accordion [Show Pinia store state]".
There is also a "Json accordion [Show Json]" to show how the values of the form changes during user interactions.
