...
export const typescriptRules = {
    ...
    // TypeScript
    '@typescript-eslint/no-unused-expressions': 'off', // FIXME: Da riattivare quando aggiornano i vari plugins
...
export const vueAndNuxtRules = {
    ...
    'vue/order-in-components': 'off', // FIXME: Da riattivare quando sarà il momento
    ...
    'vue/sort-keys': 'off', // FIXME: Per ora disabilitata per il porting del vecchio progetto
    'vue/space-unary-ops': [
        'warn',
        {
            nonwords: true,
...
export const vueAndNuxtGlobals = {
    ...
    useSlots: 'readonly',
    useState: 'readonly',
    useStoreAdvertisement: 'readonly',
    useStoreAlerts: 'readonly',
    useStoreAuctions: 'readonly',
    useStoreBreadcrumb: 'readonly',
    useStoreBuildData: 'readonly',
    useStoreCategories: 'readonly',
    useStoreCms: 'readonly',
    useStoreCognito: 'readonly',
    useStoreConsent: 'readonly',
    useStoreFooter: 'readonly',
    useStoreGdpr: 'readonly',
    useStoreGooglePublisherTag: 'readonly',
    useStoreGoogleTagManager: 'readonly',
    useStoreListing: 'readonly',
    useStoreLocale: 'readonly',
    useStoreLocations: 'readonly',
    useStoreNews: 'readonly',
    useStoreNewsCategories: 'readonly',
    useStoreNewsletter: 'readonly',
    useStorePage: 'readonly',
    useStoreProcedures: 'readonly',
    useStoreSaveSearch: 'readonly',
    useStoreTopBar: 'readonly',
    useStoreUser: 'readonly',
